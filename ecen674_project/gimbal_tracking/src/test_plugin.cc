  ...
  /// \brief A plugin to control a Velodyne sensor.
    ...
    /// \brief Constructor
		...
		virtual void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
		{
			...
			nh = ros::NodeHandle();
			command_sub = nh.subscribe("gimbal_angle_command", 1, &VelodynePlugin::commandCallback, this);
            ...
            void OnUpdate(const common::UpdateInfo & /*_info*/)
		{
			...
			float time_step = current_time - previous_time;
              ...
              // Azimuth Controller
			float angle_current = this->joint->GetAngle(0).Radian();
			...
			float ball_angle_current = this->ball_joint->GetAngle(0).Radian();
